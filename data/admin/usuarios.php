...
<div align="center">
        ...
        <td>
        	...
        	<?php 
				if(!empty($_POST['ced'])){
					...
					$ced=$_POST['ced'];		$nom=$_POST['nom'];
					$ape=$_POST['ape'];		$tel=$_POST['tel'];
					$usu=$_POST['usu'];		$tipo=$_POST['tipo'];
					$estado=$_POST['estado'];	$con=$_POST['usu'];
					
					if($_POST['proceso']=='actualizar'){
						mysql_query("UPDATE usuarios SET estado='$estado', nombre='$nom', tipo='$tipo'	where usu='$usu'");
						...
						if (preg_match("/\\s/", $usu)){ 
							...
							mysql_query("INSERT INTO usuarios (ced,estado,nombre,apellido,telefono,usu,con,tipo) 
							VALUES ('$ced','$estado','$nom','$ape','$tel','$usu','$con','$tipo')");
            ...
            <table class="table table-bordered">
                ...
                <div id="u<?php echo $row['usu']; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-header">
                        ...
                        <h3 id="myModalLabel" align="center">Actualizar Usuario <?php echo $row['nombre']; ?></h3>
                    </div>
                    <div class="modal-body" align="center">
                        ...
                        <input type="text" name="nom" autocomplete="off" required class="input-large" value="<?php echo $row['nombre']; ?>"><br>
    ...
    <div id="nuevo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            ...
            <input type="text" name="ape" autocomplete="off" required class="input-large" value=""><br>
           <strong>Telefono</strong><br>
            <input type="text" name="tel" autocomplete="off" required class="input-large" value=""><br>
            <strong>Usuario</strong><br>
